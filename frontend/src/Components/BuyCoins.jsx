...
const BuyCoins = memo(({
  ...
  async function onPlaceOrder() {
    try {
      ...
      const buyStock = await fetch("https://api-6tyd64odzq-uc.a.run.app/api/user/buyStock", {
        method: "POST",
        headers: {
        ...
        <div className="relative  rounded-lg shadow bg-gray-700">
          ...
          <div className="px-6 py-3 md:p-6">
            ...
            <div className="relative py-4">
              ...
              <input type="number" min="0" id="coinUsdValue" name="coinUsdValue" value={coinUsdPrice.current.value} readOnly={true} className=" border   text-sm rounded-lg block w-full pl-10 p-2.5  bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" />
            </div>
          </div>
          {/* Modal footer  */}
