...
const TabNavigation = memo(() => {
  return <div className="  w-full h-[200px] lg:hidden z-50 ">
      <section id="bottom-navigation" className="block fixed inset-x-0 bottom-0 z-10 bg-gradient-to-b from-gray-900 to-black rounded-t-3xl ">
        <div id="tabs" className="flex justify-between">
          ...
          <Link to="/app/watchlist" className="w-full focus:text-teal-500 hover:text-teal-500 justify-center inline-block text-center pt-2 pb-1">
